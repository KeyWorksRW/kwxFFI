...
extern "C"
{
    ...
    // Events
    MAKE_EVT_WRAPPER(EVT_RIBBONBAR_PAGE_CHANGED);
    MAKE_EVT_WRAPPER(EVT_RIBBONBAR_PAGE_CHANGING);
    MAKE_EVT_WRAPPER(EVT_RIBBONBAR_TAB_MIDDLE_DOWN);
    MAKE_EVT_WRAPPER(EVT_RIBBONBAR_TAB_MIDDLE_UP);
    MAKE_EVT_WRAPPER(EVT_RIBBONBAR_TAB_RIGHT_DOWN);
    MAKE_EVT_WRAPPER(EVT_RIBBONBAR_TAB_RIGHT_UP);
    MAKE_EVT_WRAPPER(EVT_RIBBONBAR_TAB_LEFT_DCLICK);
    MAKE_EVT_WRAPPER(EVT_RIBBONBAR_TOGGLED);
    MAKE_EVT_WRAPPER(EVT_RIBBONBAR_HELP_CLICK);
