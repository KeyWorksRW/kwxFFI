...
// from hyperlink.h
    ...
    // from listbase.h
    MAKE_EVENT_WRAPPER(EVT_LIST_BEGIN_DRAG)
    MAKE_EVENT_WRAPPER(EVT_LIST_BEGIN_RDRAG)
    MAKE_EVENT_WRAPPER(EVT_LIST_BEGIN_LABEL_EDIT)
    MAKE_EVENT_WRAPPER(EVT_LIST_END_LABEL_EDIT)
    MAKE_EVENT_WRAPPER(EVT_LIST_DELETE_ITEM)
    MAKE_EVENT_WRAPPER(EVT_LIST_DELETE_ALL_ITEMS)
    MAKE_EVENT_WRAPPER(EVT_LIST_ITEM_SELECTED)
    MAKE_EVENT_WRAPPER(EVT_LIST_ITEM_DESELECTED)
    MAKE_EVENT_WRAPPER(EVT_LIST_KEY_DOWN)
    MAKE_EVENT_WRAPPER(EVT_LIST_INSERT_ITEM)
    MAKE_EVENT_WRAPPER(EVT_LIST_COL_CLICK)
    MAKE_EVENT_WRAPPER(EVT_LIST_ITEM_RIGHT_CLICK)
    MAKE_EVENT_WRAPPER(EVT_LIST_ITEM_MIDDLE_CLICK)
    MAKE_EVENT_WRAPPER(EVT_LIST_ITEM_ACTIVATED)
    MAKE_EVENT_WRAPPER(EVT_LIST_ITEM_FOCUSED)
...
// from treebase.h
#if wxUSE_TREECTRL
    MAKE_EVENT_WRAPPER(EVT_TREE_BEGIN_DRAG)
    MAKE_EVENT_WRAPPER(EVT_TREE_BEGIN_RDRAG)
    MAKE_EVENT_WRAPPER(EVT_TREE_BEGIN_LABEL_EDIT)
    MAKE_EVENT_WRAPPER(EVT_TREE_END_LABEL_EDIT)
    MAKE_EVENT_WRAPPER(EVT_TREE_DELETE_ITEM)
    MAKE_EVENT_WRAPPER(EVT_TREE_GET_INFO)
    MAKE_EVENT_WRAPPER(EVT_TREE_SET_INFO)
    MAKE_EVENT_WRAPPER(EVT_TREE_ITEM_EXPANDED)
    MAKE_EVENT_WRAPPER(EVT_TREE_ITEM_EXPANDING)
    MAKE_EVENT_WRAPPER(EVT_TREE_ITEM_COLLAPSED)
    MAKE_EVENT_WRAPPER(EVT_TREE_ITEM_COLLAPSING)
    MAKE_EVENT_WRAPPER(EVT_TREE_SEL_CHANGED)
    MAKE_EVENT_WRAPPER(EVT_TREE_SEL_CHANGING)
    MAKE_EVENT_WRAPPER(EVT_TREE_KEY_DOWN)
    MAKE_EVENT_WRAPPER(EVT_TREE_ITEM_ACTIVATED)
    MAKE_EVENT_WRAPPER(EVT_TREE_ITEM_RIGHT_CLICK)
    MAKE_EVENT_WRAPPER(EVT_TREE_ITEM_MIDDLE_CLICK)
    MAKE_EVENT_WRAPPER(EVT_TREE_END_DRAG)
#endif
...
// from wizard.h
    ...
    MAKE_EVENT_WRAPPER(EVT_USER_FIRST)
